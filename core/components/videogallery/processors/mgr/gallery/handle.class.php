...
class videoGalleryGalleryHandleProcessor extends modObjectProcessor
{
	...
	public function initialize()
	{
		...
		$this->assetsPath = $this->modx->getOption('videogallery_assets_path', null, $this->modx->getOption('assets_path') . 'components/videogallery/');
		$this->assetsUrl = $this->modx->getOption('videogallery_assets_url', null, $this->modx->getOption('assets_url') . 'components/videogallery/');
		$this->corePath = $this->modx->getOption('videogallery_core_path', null, $this->modx->getOption('core_path') . 'components/videogallery/');
