...
/**
 * The base class for videoGallery.
 */
class videoGallery {
	/* @var modX $modx */
	public $modx;
	...
	function __construct(modX &$modx, array $config = array()) {
		...
		$corePath = $this->modx->getOption('videogallery_core_path', $config, $this->modx->getOption('core_path') . 'components/videogallery/');
		$assetsUrl = $this->modx->getOption('videogallery_assets_url', $config, $this->modx->getOption('assets_url') . 'components/videogallery/');
